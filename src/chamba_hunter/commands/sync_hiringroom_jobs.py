...
from chamba_hunter.services.hiringroom_job_ingestion_service import (
    HiringRoomJobIngestionService,
)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Sync only one known Hiring Room "
            "tenant subdomain."
        ),
    )
    ...
    print("Syncing Hiring Room jobs...")
    print(
        "Tenants: "
    ...
    print("Hiring Room sync finished")
    print("-------------------------")
    print(

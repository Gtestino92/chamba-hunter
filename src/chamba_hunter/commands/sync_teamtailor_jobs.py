...
from chamba_hunter.services.teamtailor_job_ingestion_service import (
    TeamtailorJobIngestionService,
)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Sync only one known Teamtailor "
            "tenant identifier."
        ),
    )
    ...
    service = TeamtailorJobIngestionService(
    ...
    print("Teamtailor sync finished")
    print("------------------------")
    print(
